    ...
    func render(
        ...
        case let .image(source, children):
            if let image = context.loadedImages[source] {
                ...
                let drawingCallback = TextLabel.LineDrawingAction { cgContext, line, lineOrigin in
                ...
                let attachment = TextLabel.Attachment.hold(attrString: .init(string: altText.isEmpty ? source : altText))
